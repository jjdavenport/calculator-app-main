  ...
  return (
    <>
      <section className="grid grid-cols-4 grid-rows-5 gap-4 rounded-lg p-4 one:bg-toggleBgTheme1 one:text-whiteTextTheme1 two:bg-toggleBgTheme2 two:text-whiteTextTheme2 three:bg-toggleBgTheme3 three:text-whiteTextTheme3">
        ...
        <button
          className="rounded-lg border-b-4 uppercase one:border-b-keyShadowTheme1 one:bg-keyBgTheme1 one:hover:bg-hoverKey1 two:border-b-keyShadowTheme2 two:bg-keyBgTheme2 two:hover:bg-hoverKey2 three:border-b-vividMagentaKeyShadowTheme3 three:bg-darkVioletKeyBgTheme3 three:hover:bg-hoverKey3"
          onClick={del}
        >
          Del
        </button>
        ...
        <button
          className="col-span-2 rounded-lg border-b-4 uppercase one:border-b-keyShadowTheme1 one:bg-keyBgTheme1 one:hover:bg-hoverKey1 two:border-b-keyShadowTheme2 two:bg-keyBgTheme2 two:hover:bg-hoverKey2 three:border-b-vividMagentaKeyShadowTheme3 three:bg-darkVioletKeyBgTheme3 three:hover:bg-hoverKey3"
          onClick={clear}
        >
          Reset
        </button>
        <button
          className="col-span-2 rounded-lg border-b-4 one:border-b-darkRedKeyShadowTheme1 one:bg-redKeyBgTheme1 one:hover:bg-hoverEqual1 two:border-b-darkOrangeKeyShadowTheme2 two:bg-orangeKeyBgTheme2 two:hover:bg-hoverEqual2 three:border-b-softCyanKeyShadowTheme3 three:bg-pureCyanKeyBgTheme3 three:text-textVeryDarkBlueTheme3 three:hover:bg-hoverEqual3"
          onClick={sum}
        >
          =
        </button>
