...
const Keypad = ({ output, setOutput }) => {
  ...
  const numClass = [
    "rounded-xl border-b-[6px] one:border-b-grayOrangeKeyShadowTheme1 font-bold one:bg-lightGrayOrangeKeyBgTheme1 one:text-textGrayBlueTheme1 one:hover:bg-hoverNumberKey1 two:border-b-darkGrayOrangeKeyShadowTheme2 two:bg-lightGrayYellowKeyBgTheme2 two:text-textGrayYellowTheme2 two:hover:bg-hoverNumberKey2 three:border-b-darkMagentaKeyShadowTheme3 three:bg-veryDarkVioletKeyBgTheme3 three:text-textLightYellowTheme3 three:hover:bg-hoverNumberKey3 ~sm/md:~px-1/0 ~sm/md:~py-0 ~sm/md:~text-custom/5xl",
  ];

  return (
    <>
      <main className="grid w-full grid-cols-4 grid-rows-5 rounded-xl ~sm/md:~gap-3/6 ~sm/md:~px-6/8 ~sm/md:~py-6/8 one:bg-toggleBgTheme1 one:text-whiteTextTheme1 two:bg-toggleBgTheme2 two:text-whiteTextTheme2 three:bg-toggleBgTheme3 three:text-whiteTextTheme3">
        ...
        <button
          className="rounded-xl border-b-[6px] one:border-b-grayOrangeKeyShadowTheme1 one:bg-lightGrayOrangeKeyBgTheme1 one:text-textGrayBlueTheme1 one:hover:bg-hoverNumberKey1 two:border-b-darkGrayOrangeKeyShadowTheme2 two:bg-lightGrayYellowKeyBgTheme2 two:text-textGrayYellowTheme2 two:hover:bg-hoverNumberKey2 three:border-b-darkMagentaKeyShadowTheme3 three:bg-veryDarkVioletKeyBgTheme3 three:text-textLightYellowTheme3 three:hover:bg-hoverNumberKey3"
          onClick={minus}
        >
          -
        </button>
        ...
        <button
          className={
            "col-span-2 rounded-xl border-b-[6px] uppercase ~sm/md:~text-lg/custom one:border-b-keyShadowTheme1 one:bg-keyBgTheme1 one:hover:bg-hoverKey1 two:border-b-keyShadowTheme2 two:bg-keyBgTheme2 two:hover:bg-hoverKey2 three:border-b-vividMagentaKeyShadowTheme3 three:bg-darkVioletKeyBgTheme3 three:hover:bg-hoverKey3"
          }
          onClick={clear}
        >
          Reset
